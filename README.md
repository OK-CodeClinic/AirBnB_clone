...
AirBnB is task provided byn ALX School of Software Engineering; it is a Web App that is intergrated with Frontend Infrastructure, with Database and Restful API in a clone of AirBnB.

In this project, i only implements the console.
